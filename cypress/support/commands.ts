...
declare namespace Cypress {
  interface Chainable<Subject = any> {
    ...
    getDemoMicroProgram(): typeof getDemoMicroProgram;
  }
}
...
Cypress.Commands.add('getDemoMicroProgram', getDemoMicroProgram);
//
// ***********************************************
